...
<div class="container">
	...
	<br>
	<h4>Intro</h4>
	<p>Hello and welcome to Armchair Mage Dev. My name is Valmitic and I've been playing World of Warcraft for over 12 years now. I started in August 2007 with the first class being Mage. Throughout my years of playing, I've switched different classes for a short time for each different raid tier for each expansion but always switch back to my mage.</p>
	<br>
	<h4>The Synopsis</h4>
	<p>After the Legion expansion. Mages (and most classes really) lost not only their artifact spell, but a lot of passives from their artifact weapons while gaining next to nothing in return. I created this website with the intent to fixing some of the problems with the mage class right now in Battle for Azeroth. The artifact abilties that where made talents in BfA are now part of the specialization (like Ebonbolt), and some of the passives effects from the artifacts and legiondaries have been baked into each specialization or is now a talent in the talent tree.</p>
	<br>
	<h4>A Disclaimer</h4>
	<p>Before you scroll down further, the levels shown on the talent tree are based off leaks regarding the upcoming expansion for WoW with the possibility of a level squish. And any other information for the next expansion that was posted on 4chan, then MMO champion and Reddit. Most of the numbers you see on the new spells are not 100% set in stone.</p>
	<br>
	<p>NOTE: Mouseover the <b data-toggle="tooltip" title="Spell Name">Spell Names</b> for tooltip information.</p>
</div>
</div>
<hr>
<br>
...
<div class="container">
	<div class="general" id="generaltalent">
	<h2>General Talents Changes</h2>
</div>
	<br>
	<ul>
		<h3>Level 20 (30 pre xpac) talent changes</h3>
		<br>
		<li><b data-toggle="tooltip" title="Teleports you 20 yards, unless something is in the way. Unaffected by global cooldown and castable while casting but no longer frees you from stuns and bonds. 2 charges (18 sec recharge).">Shimmer</b>: Recharge reduced by 2 sec and Tooltip update - No longer breaks stuns and roots</li>
		<br>
		<li>Talent One and Three: The <b data-toggle="tooltip" title="Arcane: Temporal Momentum. Fire: Blazing Soul. Frost: Chilling Presence.">First</b> and <b data-toggle="tooltip" title="Arcane: Everywhere at Once. Fire: Cauterizing Blink. Frost: Ice Floes.">Third</b> talents in this row has been replaced or redesign for each specalization. See below for more details.
		</li>
	</ul>
	<br>
...
Passive: At any moment during combat, gain a charge evocation for 1 sec.">Time Anomaly</b> has been redesigned. Now an active spell with a 1 min cooldown with a passive component.</li>
	...
	<li><b class="Wex" data-toggle="tooltip" title="Launches an Arcane Orb forward from your position traveling up to 40 yards dealing X arcane damage then exploding for Y damage.">Arcane Orb</b> now explodes upon reaching max range.</li>
	<br>
